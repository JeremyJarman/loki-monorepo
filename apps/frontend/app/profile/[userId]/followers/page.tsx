...
import { getFollowers, followUser, unfollowUser, getFollowingSet, type ProfileUserSummary } from '@/lib/following';
...
export default function FollowersPage() {
  ...
  const handleFollow = async (targetUserId: string) => {
    ...
    const target = followers.find((u) => u.userId === targetUserId);
  ...
  return (
    <div className="space-y-6">
      ...
      {followers.length === 0 ? (
        <p className="font-body text-text-paragraph">No followers yet.</p>
      ) : (
